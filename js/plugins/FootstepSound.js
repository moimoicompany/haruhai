...
(function() {
    ...
    var footStepJson = {
        ...
        always     : {
            interval: 2,
            walk1   : {name: 'foot_cut', volume: 40, pitch: 100, pan: 0},
            walk2   : {name: 'foot_cut', volume: 50, pitch: 100, pan: 0},
            dash1   : {name: 'foot_cut', volume: 40, pitch: 90, pan: 0},
            dash2   : {name: 'foot_cut', volume: 50, pitch: 90, pan: 0},
        },
        // 梯子属性通過時の足音
        ladder     : {
            interval: 1,
        ...
        terrainTag1: {
            interval: 2,
            walk1   : {name: 'foot_tatami', volume: 40, pitch: 100, pan: 0},
            walk2   : {name: 'foot_tatami', volume: 50, pitch: 100, pan: 0},
            dash1   : {name: 'foot_tatami', volume: 40, pitch: 90, pan: 0},
            dash2   : {name: 'foot_tatami', volume: 50, pitch: 90, pan: 0},
        },
        // 地形タグ 2 通過時の足音
        terrainTag2: {
            interval: 2,
            walk1   : {name: 'foot_kusa', volume: 40, pitch: 100, pan: 0},
            walk2   : {name: 'foot_kusa', volume: 50, pitch: 100, pan: 0},
            dash1   : {name: 'foot_kusa', volume: 40, pitch: 90, pan: 0},
            dash2   : {name: 'foot_kusa', volume: 50, pitch: 90, pan: 0},
        },
