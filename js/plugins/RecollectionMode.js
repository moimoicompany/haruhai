...
//-----------------------------------------------------------------------------
    var rngd_recollection_mode_settings = {
        ...
        "rec_cg_set": {
            "1": {
                "title": "出口は、くらくてあたたかい、胎内から。",
                "pictures": ["degutihatainai"],
                "common_event_id": 7,
                "switch_id": 111,
 //               "thumbnail": "room1_thumbnail"
            ...
            "2": {
                "title": "家族三人?",
                "pictures": ["kazokusyasin_2"],
                "common_event_id": 7,
                "switch_id": 112
            },
//            "3": {
//                "title": "家族三人･･･?",
//                "pictures": ["kazokusyasin"],
//                "common_event_id": 7,
//                "switch_id": 113
//            },
            "3": {
    ...
    Scene_Recollection.prototype.commandDoRecMode = function() {
        ...
        if (this._rec_list.is_valid_picture(this._rec_list.index() + 1)) {
            ...
            if (this._mode == "recollection") {
                ...
                //コマンド枠表示プラグインとの競合を避けるためにコマンド枠更新処理を追加。
...
//-----------------------------------------------------------------------------
    ...
    Window_TitleCommand.prototype.makeCommandList = function() {
        ...
        this.addCommand(TextManager.newGame,   'options');
